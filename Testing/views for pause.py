...
with `view = MyView()` and then use the "gself.window.set_view(view)" method.
...
class GameView(arcade.View):
    ...
    def on_key_press(self, key, _modifiers):
        if key == arcade.key.ESCAPE:
            # pass gself, the current view, to preserve this view's state
