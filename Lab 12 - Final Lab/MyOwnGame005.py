'''
- die wichtigsten Änderungen von Version 004 zu 005:

- screen 1920 breit, spielfläche 1000 und zentriert
- intro-musik läuft jetzt endlos, solange game nicht gestartet wird
- playership hat jetzt bewegungsgrenzen bei screenbreite/2 +- 450
- startscreen flugvektoren geändert / angepasst
- game-hintergrundbild gegen scrollende textur (spacefog) getauscht TODO läuft noch nicht Übergangslos
- battlemusic im  game TODO mehrere instanzen paralell verhindern, wenn man über ESC wieder rausgeht und neu startet
- 3 variablen für spacefog und battlemusic zugefügt
- variable framedivisor zur anpassung der startscreen-einflugdarstellung, wert von 100 auf 50 gesetzt (schneller)
'''
...
spacefog_speed = .4
spacefog_alpha = 100
volume_battlemusic = 0.3  # skala von 0 bis 1
framedivisor = 50
...
def main():
    ...
    #window.set_fullscreen(fullscreen=False, screen=None, mode=None, width=None, height=None)
    start_view = MyStartScreen()
