'''
- die wichtigsten Änderungen von Version 009 zu 010:
- Fensterbreite auf 1600 reduziert, um im Hintergrund ergebnisse von print-befehlen sehen zu können, bei testläufen.
- torpedosound und Textur geändert
- enemies erscheinen jetzt etwas kleiner, wenn sie weiter weg sind  # explosionen usw. haben diesen effekt (noch?) nicht
- die letzte vorhandene scrollfog-ebene wird jetzt über die enemies gezeichnet (sieht das besser aus?)
- Spielfläche von 1000 x 1000 erweitert auf 1080 x 1080  (evtl sind einige scrollfogtexturen noch zu skalieren)
- next_level variable löscht beim Explosion.update aktive explosionsreste (Animationen)
- Class Portal(): enemie nachschub-portal vor Levelbeginn
- portal animation verbessert und sound dazugepackt
-
