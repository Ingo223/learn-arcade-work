'''
- die wichtigsten Änderungen von Version 007 zu 008:

- class Backgroundstar hat jetzt eigene setup methode zur sternerstellung
- scrollfog auslesen jetzt mit  < enumerate >
- neue class LevelReadyScreen(arcade.View) wird jetzt am Anfang mit Levelnummer angezeigt
- da es scheinbar keine gefährlichen Gegner gibt, wurde eine energiesparende Feuerrate festgelegt, "shoot_delay"
'''
