'''
- die wichtigsten Änderungen von Version 010 zu 011:

- class EnemyBullet
- einzelne enemies schiessen jetzt random zurück
- enemies zielen beim feuern auf den player
- bullets sind rotierende feuerbälle
